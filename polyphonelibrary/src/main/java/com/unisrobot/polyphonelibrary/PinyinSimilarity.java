...
package com.unisrobot.polyphonelibrary;
...
//    String specialHanziString="年级班分";
	...
	String numberString="零一二三四五六七八九十百点";
    String specialHanziString="打开投屏影我爱您她";
	...
	public String changeWordProcessEnglish(String strInput){
 	...
 	public String changeEnglishWord(String strInput){
 		if(englishString26.contains(strInput)){
 	    	LogUtil.logWithMethod(new Exception(),"is english");
 	    	return strInput;
 	    }
    		...
    		for(int j=i+1;j<len;j++){
		    	if(str.contentEquals(list.get(j))){
		    		LogUtil.logWithMethod(new Exception(),
		    				"myCharAll["+i+"]="+myCharAll.charAt(i)
		    				+" myCharAll["+j+"]="+myCharAll.charAt(j)
		    				+" pinyin="+str);
		    	}
    		}
    		i++;
